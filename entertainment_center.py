...
pans_labyrinth = media.Movie("Pan's Labyrinth",
                   "Story about a little girl who ventures a crazy world.",
...
fight_club = media.Movie("Fight Club",
                   "First rule about the fight club is: You do not talk about fight club.",
...
the_avengers = media.Movie("The Avengers",
                   "Group of super hero badasses try to save humanity.",
